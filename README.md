...
I have created a simple guide to spinning up a Wi-Fi hotspot using Kali Linux and any old spare PC or Raspberry Pi you have knocking around.
...
4) Routed, not bridged. My simple configuration works fine but is routed, not bridged, so broadcasts and servers connected via the Wi-Fi won't work with respect to computers on the ethernet port.
